/// <summary>
/// ERP-NAV Master Data Management: Automate IC Transactions
/// It is a copy of standard rep "Complete IC Inbox Action" with the changes to set journal template and batch name from GLSetup
/// </summary>
report 50021 "GXL AutoCompleteICInboxAction"
{
    Caption = 'Auto Complete IC Inbox Action';
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem("IC Inbox Transaction"; "IC Inbox Transaction")
        {
            ...
            begin
                ...
                // end;
                GetGLSetup;
                GLSetup.TestField("GXL Incoming IC Template Name");
                GLSetup.TestField("GXL Incoming IC Batch Name");
                GLSetup.TestField("GXL Automate IC E-Mail");
                TempGenJnlLine."Journal Template Name" := GLSetup."GXL Incoming IC Template Name";
                TempGenJnlLine."Journal Batch Name" := GLSetup."GXL Incoming IC Batch Name";
                GenJnlTemplate.Get(TempGenJnlLine."Journal Template Name");
                IsHandled := false;
                OnBeforeTestGenJnlTemplateType(TempGenJnlLine, GenJnlTemplate, IsHandled);
                if not IsHandled then
