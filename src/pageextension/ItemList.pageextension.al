pageextension 50004 "GXL Item List" extends "Item List"
{
    layout
    {
        ...
        {
            field("GXL GXLDivision Code"; Rec."LSC Division Code")
            {
                ApplicationArea = All;
            }
        ...
        {
            field("GXL GXLRetail Product Code"; Rec."LSC Retail Product Code")
            {
                ApplicationArea = All;
            }
