tableextension 50023 "GXL Purch. Inv. Header" extends "Purch. Inv. Header"
{
    fields
    {
        ...
        field(50321; "GXL Total Weight"; Decimal)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = sum("Purch. Inv. Line"."GXL Gross Weight" where("Document No." = field("No.")));
            Editable = false;
            DecimalPlaces = 0 : 5;
        }
        field(50322; "GXL Total Cubage"; Decimal)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = sum("Purch. Inv. Line"."GXL Cubage" where("Document No." = field("No.")));
            Editable = false;
            DecimalPlaces = 0 : 5;
        }
