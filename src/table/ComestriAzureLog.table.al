table 50480 "GXL Comestri Azure Log"
{
    Caption = 'Comestri Azure Log';
    DataClassification = CustomerContent;
    LookupPageId = "GXL Comestri Azure Log";
    DrillDownPageId = "GXL Comestri Azure Log";
    ...
    fields
    {
        ...
        field(2; "Web Service Name"; Option)
        {
            Caption = 'Web Service Name';
            DataClassification = CustomerContent;
            OptionMembers = "Product","SOH";
            OptionCaption = 'Product,SOH';
        }
    ...
    procedure InitAzureLogEntry(WebServName: Option "Product","SOH"; FileNo: Integer; StartEntryNo: Integer; EndEntryNo: Integer)
    begin
        Init();
        "Batch ID" := 0;
        "File Number" := FileNo;
    ...
    procedure InitAzureLogEntry(WebServName: Option "Product","SOH"; FileNo: Integer; StartDateTime: DateTime; EndDateTime: DateTime)
    begin
        Init();
        "Batch ID" := 0;
        "File Number" := FileNo;
