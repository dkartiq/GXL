xmlport 50272 "GXL WH-Item Adjsutments"
{
    // 001  18.03.2024 LCB-291 code added for mapping
    ///<Summary>
    //Insert into WHMessage Lines
    //Another routine (report Import Location FIles) will process to create inventory adjustment
    ///</Summary>
        ...
        textelement(ItemAdjust)
        {
            tableelement("WH Message Lines"; "GXL WH Message Lines")
            {
                ...
                fieldelement(ILC; "WH Message Lines"."Item No.")
                {
                    ...
                    var
                        ReasonCodeMapping: Record "GXL 3PL Reason Code Mapping"; // >> 001 <<
                    begin
                        ...
                        "WH Message Lines"."Location Code" := gStoreCode;
