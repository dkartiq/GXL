/// <summary>
/// CR103 - G/L Import for Vet: dim1, dim2 and document date are mandatory
/// </summary>
xmlport 50005 "GXL Gen. Jnl. Import - Vet"
{
    Caption = 'GL Journal Import - Vet';
    Format = VariableText;
    ...
    begin
        ...
        if GenJournalLine."Shortcut Dimension 1 Code" = '' then
            Error(MandatoryFieldErr, GenJournalLine.FieldCaption("Shortcut Dimension 1 Code"), RowNo);
